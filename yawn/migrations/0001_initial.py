# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2016-12-28 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('command', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), size=None)),
                ('queue', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='yawn.Queue')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_version', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='yawn.Workflow')),
            ],
        ),
        migrations.AddField(
            model_name='workflow',
